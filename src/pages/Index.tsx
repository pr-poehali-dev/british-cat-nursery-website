        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              ...
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed">Вы явно заглянули сюда в поисках нового друга! Мы на 99% уверены, что Ваше сердце будет украдено именно нашим котёнком. Почему? Тут объяснения излишни. Лучше показать. Приглашаем Вас познакомится с нашими плюшевыми попами. Мы очень счастливы находиться в окружении своих мурчащих британцев и готовы поделиться этим счастьем с Вами!</p>
              <Button 
                onClick={() => scrollToSection('contact')}
